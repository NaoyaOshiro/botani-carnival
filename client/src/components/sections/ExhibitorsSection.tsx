...
const categoryConfig: Record<string, { label: string; bg: string; text: string; icon: string }> = {
  "植物": { label: "植物", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
  "植木鉢": { label: "植木鉢", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
  "雑貨": { label: "雑貨", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
  "植物・植木鉢": { label: "植物・鉢", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
  "植物・雑貨": { label: "植物・雑貨", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
  "雑貨・植木鉢": { label: "雑貨・鉢", bg: "white", text: "oklch(0.20 0 0)", icon: "" },
};
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 pb-3 pt-1">
          ...
          <span className="text-xs text-[oklch(0.35_0.02_0)] border border-[oklch(0.80_0.02_0)] rounded px-2 py-0.5">
            {cat.label}
          </span>
        </div>
      </div>
